package cat.api.login.service;


import cat.api.login.config.SecurityConfig;
import cat.api.login.config.SuperUserConfig;
import cat.api.login.config.TestUserConfig;
import cat.api.login.dto.AuthenticationRequest;
import cat.api.login.dto.UserDto;
import cat.api.login.proxy.HttpProxy;
